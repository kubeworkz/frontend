...
export interface ProjectUpdateRequest {
  project: { settings?: ProjectSettings; name?: string; default_endpoint_settings?: PgSettingsData };
}
...
export interface BranchCreateRequest {
  ...
  branch?: { parent_id?: string; name?: string; parent_lsn?: string; parent_timestamp?: string };
}
...
export type ProjectOperations = ProjectResponse & OperationsResponse;
...
export class HttpClient<SecurityDataType = unknown> {
  ...
  constructor({ securityWorker, secure, format, ...axiosConfig }: ApiConfig<SecurityDataType> = {}) {
    this.instance = axios.create({
      ...axiosConfig,
      baseURL: axiosConfig.baseURL || "https://console.cloudrock.ca/api/v2",
    });
    this.secure = secure;
    this.format = format;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @secure
   */
  listBillingInvoices = (params: RequestParams = {}) =>
    this.request<InvoiceListResponse, GeneralError>({
   ...
   * @secure
   */
  listUserAvailableApplications = (query: ListUserAvailableApplicationsParams, params: RequestParams = {}) =>
    this.request<ApplicationsListResponse, GeneralError>({
      path: `/applications`,
      method: "GET",
      query: query,
      secure: true,
   ...
   * @secure
   */
  unlinkProjectFromVercelIntegrations = (projectId: string, params: RequestParams = {}) =>
    this.request<EmptyResponse, GeneralError>({
      path: `/projects/${projectId}/applications/vercel`,
      method: "DELETE",
      secure: true,
      format: "json",
      ...params,
   ...
   * @secure
   */
  revokeOAuthConsent = (clientId: string, params: RequestParams = {}) =>
    this.request<EmptyResponse, GeneralError>({
      path: `/applications/oauth/${clientId}`,
      method: "DELETE",
      secure: true,
      format: "json",
      ...params,
  ...
  updateProject = (projectId: string, data: ProjectUpdateRequest, params: RequestParams = {}) =>
    this.request<ProjectOperations, GeneralError>({
      path: `/projects/${projectId}`,
      method: "PATCH",
      body: data,
      secure: true,
   ...
   * @secure
   */
  runProjectQuery = (projectId: string, data: QueryRequest, params: RequestParams = {}) =>
    this.request<QueryResponse, GeneralError>({
   ...
   * @secure
   */
  listProjectSavedQueries = (projectId: string, params: RequestParams = {}) =>
    this.request<SavedQuery[], GeneralError>({
      path: `/projects/${projectId}/saved_queries`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
   ...
   * @secure
   */
  createSavedQuery = (projectId: string, data: SavedQueryCreateRequest, params: RequestParams = {}) =>
    this.request<SavedQuery, GeneralError>({
      path: `/projects/${projectId}/saved_queries`,
      method: "POST",
      body: data,
  ...
  revokePermissionFromProject = (projectId: string, permissionId: string, params: RequestParams = {}) =>
    this.request<ProjectPermission, GeneralError>({
      path: `/projects/${projectId}/permissions/${permissionId}`,
      method: "DELETE",
      secure: true,
      format: "json",
      ...params,
   ...
   * @secure
   */
  updateProjectSavedQuery = (savedQueryId: number, data: SavedQueryUpdateRequest, params: RequestParams = {}) =>
    this.request<SavedQuery, GeneralError>({
      path: `/saved_queries/${savedQueryId}`,
      method: "PATCH",
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  deleteSavedQuery = (savedQueryId: number, params: RequestParams = {}) =>
    this.request<SavedQuery, GeneralError>({
      path: `/saved_queries/${savedQueryId}`,
      method: "DELETE",
      secure: true,
   ...
   * @secure
   */
  getProjectQueryHistory = ({ projectId, ...query }: GetProjectQueryHistoryParams, params: RequestParams = {}) =>
    this.request<QueryHistoryResponse, GeneralError>({
  ...
  createProjectBranch = (projectId: string, data?: BranchCreateRequest, params: RequestParams = {}) =>
    this.request<
      BranchResponse & EndpointsResponse & OperationsResponse & ConnectionURIsOptionalResponse,
      GeneralError
    >({
  ...
  setPrimaryProjectBranch = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<BranchOperations, GeneralError>({
      path: `/projects/${projectId}/branches/${branchId}/set_as_primary`,
      method: "POST",
      secure: true,
      format: "json",
      ...params,
  ...
  listProjectBranchEndpoints = (projectId: string, branchId: string, params: RequestParams = {}) =>
    this.request<EndpointsResponse, GeneralError>({
      path: `/projects/${projectId}/branches/${branchId}/endpoints`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
  ...
  getProjectBranchDatabase = (projectId: string, branchId: string, databaseName: string, params: RequestParams = {}) =>
    this.request<DatabaseResponse, GeneralError>({
      path: `/projects/${projectId}/branches/${branchId}/databases/${databaseName}`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
  ...
  getProjectBranchRole = (projectId: string, branchId: string, roleName: string, params: RequestParams = {}) =>
    this.request<RoleResponse, GeneralError>({
      path: `/projects/${projectId}/branches/${branchId}/roles/${roleName}`,
      method: "GET",
      secure: true,
      format: "json",
      ...params,
  ...
  resetProjectBranchRolePassword = (
    ...
    this.request<RoleOperations, GeneralError>({
      path: `/projects/${projectId}/branches/${branchId}/roles/${roleName}/reset_password`,
      method: "POST",
      secure: true,
      format: "json",
      ...params,
  ...
  startProjectEndpoint = (projectId: string, endpointId: string, params: RequestParams = {}) =>
    this.request<EndpointOperations, GeneralError>({
      path: `/projects/${projectId}/endpoints/${endpointId}/start`,
      method: "POST",
      secure: true,
      format: "json",
      ...params,
  ...
  suspendProjectEndpoint = (projectId: string, endpointId: string, params: RequestParams = {}) =>
    this.request<EndpointOperations, GeneralError>({
      path: `/projects/${projectId}/endpoints/${endpointId}/suspend`,
      method: "POST",
      secure: true,
      format: "json",
      ...params,
   ...
   * @secure
   */
  authProjectEndpointPasswordlessSession = (
    projectId: string,
    endpointId: string,
    data: EndpointPasswordlessSessionAuthRequest,
    params: RequestParams = {},
  ) =>
    this.request<void, GeneralError>({
      path: `/projects/${projectId}/endpoints/${endpointId}/passwordless_auth`,
      method: "POST",
      body: data,
      secure: true,
      type: ContentType.Json,
   ...
   * @secure
   */
  getCurrentUserConsumption = (query: GetCurrentUserConsumptionParams, params: RequestParams = {}) =>
    this.request<ConsumptionHistoryPeriodResponse, GeneralError>({
      path: `/users/me/consumption`,
      method: "GET",
      query: query,
      secure: true,
      format: "json",
  ...
  healthCheck = (params: RequestParams = {}) =>
    this.request<HealthCheck, GeneralError>({
      path: `/healthz`,
      method: "GET",
      secure: true,
      ...params,
