...
export const RELEASE_NOTES_URL = 'https://cloudrock.ca/docs/release-notes/';
export const EMAIL_BRANCHING = 'iwantbranching@cloudrock.ca';
export const EMAIL_SUPPORT = 'support@cloudrock.ca';
export const EARLY_ACCESS_LINK = 'https://cloudrock.ca/early-access/';

export const FREE_TIER_LIMITS = [
  'One project with up to 10 branches',
  '3 GB of storage in each branch',
  '100 compute hours per month',
];

export enum StoreKeys {
  NewProjectOnboardingDone = 'cloudrock_newProjectOnboarding_done',
  NewProjectOnboardingStep = 'cloudrock_newProjectOnboarding_step',
}
